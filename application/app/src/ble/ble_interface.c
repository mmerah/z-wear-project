...
/** Semaphore for extern use for indicating that a device has deconnected from the sensor. */
extern struct k_sem ble_deconn;

/** Semaphore for extern use for indicating that the BLE layer has been initialized. */
